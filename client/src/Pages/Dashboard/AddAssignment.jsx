        ...
        <Layout>
            <section className="flex flex-col gap-6 items-center py-8 px-3 min-h-[100vh]">
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="flex gap-2">
                            <button type="submit" className="btn btn-primary w-full py-2 font-semibold text-lg">
                                {isEditing ? "Update Question" : "Add Assignment Question"}
                            </button>
                            {isEditing && (
                ...
                <div className="md:w-[750px] w-full flex flex-col gap-4">
                    <h2 className="text-2xl font-bold dark:text-white">Existing Assignment Questions</h2>
                    {quizzes && quizzes.length > 0 ? (
                        ...
                        <p className="text-gray-500">No assignment questions added yet.</p>
                    )}
                </div>
            </section>
        </Layout>
